export const VENUES: Record<string, { address: string; district: string; lat: number; lon: number }> = {
  "CK Zamek": { address: "Święty Marcin 80/82", district: "StareMiasto", lat: 52.408, lon: 16.919 },
  "Stary Browar": { address: "Półwiejska 42", district: "StareMiasto", lat: 52.403, lon: 16.926 },
  "Kino Muza": { address: "Święty Marcin 30", district: "StareMiasto", lat: 52.406, lon: 16.920 },
  "Teatr Polski": { address: "27 Grudnia 8/10", district: "StareMiasto", lat: 52.407, lon: 16.935 },
  "Teatr Nowy": { address: "Dąbrowskiego 5", district: "StareMiasto", lat: 52.407, lon: 16.930 },
  "Teatr Wielki": { address: "Fredry 9", district: "StareMiasto", lat: 52.409, lon: 16.928 },
  "Teatr Animacji": { address: "Św. Marcin 80/82", district: "StareMiasto", lat: 52.407, lon: 16.918 },
  "Polski Teatr Tańca": { address: "Taczaka 8", district: "StareMiasto", lat: 52.405, lon: 16.925 },
  ...
  "Aula UAM": { address: "Wieniawskiego 1", district: "StareMiasto", lat: 52.406, lon: 16.927 },
  "Aula Artis": { address: "Święty Marcin 40", district: "StareMiasto", lat: 52.407, lon: 16.922 },
  "Aula Nova": { address: "Święty Marcin 40", district: "StareMiasto", lat: 52.407, lon: 16.923 },
  "Cuba Libre": { address: "Wrocławska 21", district: "StareMiasto", lat: 52.405, lon: 16.935 },
  "Galeria Miejska Arsenał": { address: "Stary Rynek 6", district: "StareMiasto", lat: 52.407, lon: 16.934 },
  "Galeria Ego": { address: "Wyspiańskiego 41", district: "StareMiasto", lat: 52.404, lon: 16.928 },
  "Collegium Da Vinci": { address: "Kutrzeby 10", district: "Grunwald", lat: 52.397, lon: 16.895 },
  "CK Zamek - Sala Wielka": { address: "Święty Marcin 80/82", district: "StareMiasto", lat: 52.408, lon: 16.919 },
  "Scena Wspólna": { address: "Brandstaettera 1", district: "Winogrady", lat: 52.425, lon: 16.940 },
  "Dom Bretanii": { address: "Stary Rynek 37", district: "StareMiasto", lat: 52.406, lon: 16.932 },
  "Biblioteka Uniwersytecka UAM": { address: "Ratajczaka 38/40", district: "StareMiasto", lat: 52.405, lon: 16.925 },
  "POSiR Chwiałka": { address: "Spychalskiego 38", district: "Wilda", lat: 52.381, lon: 16.920 },
  "Termy Maltańskie": { address: "Termalna 1", district: "NoweMiasto", lat: 52.398, lon: 16.970 },
  "Arena": { address: "Wyspiańskiego 33", district: "StareMiasto", lat: 52.403, lon: 16.930 },
  "Enea Stadion": { address: "Bułgarska 17", district: "Jezyce", lat: 52.418, lon: 16.894 },
  "Stadion Miejski": { address: "Bułgarska 17", district: "Jezyce", lat: 52.418, lon: 16.894 },
  "Stadion Poznań": { address: "Bułgarska 17", district: "Jezyce", lat: 52.418, lon: 16.894 },
  "Malta": { address: "Maltańska 1", district: "NoweMiasto", lat: 52.398, lon: 16.960 },
  ...
  "Klub U Bazyla": { address: "Grunwaldzka 22", district: "Grunwald", lat: 52.398, lon: 16.892 },
  "Scena nad Rusałką": { address: "Rusałka", district: "Winogrady", lat: 52.432, lon: 16.928 },
  "Barak Kultury": { address: "Święty Marcin 38", district: "StareMiasto", lat: 52.407, lon: 16.921 },
  "Pałac Górków": { address: "Wodna 27", district: "StareMiasto", lat: 52.409, lon: 16.941 },
  "Akademia Lubrańskiego": { address: "Lubrańskiego 1", district: "StareMiasto", lat: 52.411, lon: 16.945 },
  "Muzeum Archeologiczne": { address: "Wodna 27", district: "StareMiasto", lat: 52.409, lon: 16.941 },
  "OSB Śródka": { address: "Rynek Śródecki 7", district: "NoweMiasto", lat: 52.412, lon: 16.956 },
  "POSiR Rataje": { address: "Piłsudskiego 30", district: "Rataje", lat: 52.380, lon: 16.963 },
